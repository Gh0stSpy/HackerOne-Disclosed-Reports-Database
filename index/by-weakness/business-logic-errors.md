...
|--:|:--|:--|:--|:--|--:|--:|
| 1 | [3507241](../../reports/3507241.md) | Authorization Bypass in Starknet Snap via enableAuthorize parameter leads to unauthorized  | MetaMask | Medium | $350 | 84 |
...
| 4 | [3699522](../../reports/3699522.md) | `check_reserve_proof` counts duplicate entries: one output can inflate `total` | Monero | Medium | — | 41 |
| 5 | [2061982](../../reports/2061982.md) | Create account without auth via response manipulation | U.S. Dept Of Defense | Low | — | 40 |
| 6 | [3648638](../../reports/3648638.md) | monero:// deeplink parsing accepts tx_amount=(all) and can trigger send-all transaction mo | Monero | Medium | — | 16 |
| 7 | [3515557](../../reports/3515557.md) | Loss of multisig funds through single malicious participant's deliberate deception | Monero | Medium | — | 11 |
