...
|--:|:--|:--|:--|:--|--:|--:|
| 1 | [3522157](../../reports/3522157.md) | SSRF with bypass leads to client side hosting / vulnerabilities ( XSS and others ) | DuckDuckGo | Medium | $500 | 21 |
...
| 3 | [3887969](../../reports/3887969.md) | SSRF via URL Parser Differential in `normalize_request_url` (wlc) | Weblate | High | — | 40 |
...
| 8 | [3303283](../../reports/3303283.md) | Unauthenticated blind SSRF in Circles signature verification bypasses Nextcloud local-addr | Nextcloud | Medium | — | 11 |
